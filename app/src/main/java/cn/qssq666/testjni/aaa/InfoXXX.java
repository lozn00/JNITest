package cn.qssq666.testjni.aaa;
...
public class InfoXXX {
    ...
    public InfoXXX(String title, int age, long birthday, int sex) {
        this.title = title;
        this.age = age;
        this.birthday = birthday;
        this.sex = sex;
    ...
    public InfoXXX(String title, int age) {
    ...
    public InfoXXX(int age, int sex) {
    ...
    public static InfoXXX createObj(){
        return new InfoXXX("这是我的标题",15);
    }
}
